...
the FCCH burst fast and accurately. Figure \ref{fig:fch} shows the ratio of average error power to input power. The data is gathered by my R820T with RTL2832U. The average error is very low
