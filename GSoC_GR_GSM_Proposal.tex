...
\item \textbf{8th Phase (2 weeks)} : Integrate all parts with real-time capabilities.
\item \textbf{9th Phase (2 weeks)} : QA test, code clean-up, adding documentation and final submission.
